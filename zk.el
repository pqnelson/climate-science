...
(defvar zk-dir default-directory)
(defvar zk-tex-dir (format "%stex" zk-dir))
...
(defun zk-insert-label-please ()
  (interactive)
  (insert "\\label{" (zk-generate-tag-name) "}%")
  (zk-update-number))
...
(global-set-key "\C-b" #'zk-insert-label-please)
